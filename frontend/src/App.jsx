...
function App() {
  ...
  return (
    <Router>
      <div className="min-h-screen flex flex-col relative overflow-hidden bg-[#0d0221]">
        {/* Background Layers */}
        <div className="fixed inset-0 z-neg">
        ...
        <div className="relative z-10 flex flex-col min-h-screen">
          <nav className="bg-[#0d0221]/80 backdrop-blur-md border-b-4 border-[#ff00ff] shadow-[0_5px_15px_rgba(255,0,255,0.3)] sticky top-0 z-50 p-6 flex justify-between items-center">
